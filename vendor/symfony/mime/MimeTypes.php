...
final class MimeTypes implements MimeTypesInterface
{
    ...
    private const MAP = [
        ...
        'application/xml-external-parsed-Entities' => ['ent'],
        ...
        'text/xml-external-parsed-Entities' => ['ent'],
        'text/yaml' => ['yaml', 'yml'],
    ...
    private const REVERSE_MAP = [
        ...
        'ent' => ['application/xml-external-parsed-Entities', 'text/xml-external-parsed-Entities'],
