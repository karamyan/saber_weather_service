...
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
    ...
    /**
     * Get the queueable relationships for the Entities.
     *
     * @return array
     */
    ...
    /**
     * Get the queueable connection for the Entities.
     *
     * @return string|null
     */
    ...
    /**
     * Get the broadcast channel route definition that is associated with the given Entities.
     *
     * @return string
     */
    ...
    /**
     * Get the broadcast channel name that is associated with the given Entities.
     *
     * @return string
     */
