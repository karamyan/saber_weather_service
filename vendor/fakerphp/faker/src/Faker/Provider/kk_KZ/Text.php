...
EOT;
    ...
    *** START: FULL LICENSE ***
    ...
    Entities or entities that offer(s) the Work under the terms of this
    License. "Original Author" means, in the case of a literary or
    artistic work, the individual, individuals, Entities or entities who
    created the Work or if no individual or Entities can be identified, the
    ...
    phonogram the producer being the person or legal Entities who first
    ...
    Entities exercising rights under this License who has not previously
    ...
    institute, publishing Entities, journal) for attribution ("Attribution
