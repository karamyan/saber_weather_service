...
class Populator
{
    ...
    /**
     * Add an order for the generation of $number records for $Entities.
     *
    ...
    public function addEntity(
        ...
        if (null === $mapper) {
            throw new \InvalidArgumentException('No mapper can be found for Entities ' . $entityName);
        }
    ...
    public function execute($locator = null)
    {
        ...
        if (null === $locator) {
            throw new \InvalidArgumentException('No Entities manager passed to Spot Populator.');
        }
